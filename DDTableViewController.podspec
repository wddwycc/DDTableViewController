#
#  Be sure to run `pod spec lint DDTableViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "DDTableViewController"
  s.version      = "0.0.2"
  s.summary      = "A brilliant way to use UITableView"
  ...
  s.homepage     = "https://github.com/wddwycc/DDTableViewController"
  ...
  s.source       = { :git => "https://github.com/wddwycc/DDTableViewController.git", :tag => "0.0.2" }
